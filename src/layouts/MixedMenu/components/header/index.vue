...
<template>
	<el-row class="header-container">
		<transition>
			<el-row
				v-bind:class="
					TStore.topBarIsDark ? 'header-tools-container-dark' : 'header-tools-container'
				"
				v-show="HStore.isShow"
			>
				<el-col
					:span="4"
					:xs="12"
				...
				<el-col :span="14" :xs="12" class="header-center">
					<div class="header-pMenu-container">
						<div
							class="header-pMenu"
							v-bind:class="
						...
						>
							...
							<el-text v-bind:style="TStore.topBarIsDark ? { color: 'white' } : ''">{{
								$t(item.meta.title)
							}}</el-text>
						</div>
					</div>
				</el-col>
				<el-col :span="6" :xs="12" class="header-right">
					<rightTool />
				</el-col>
			</el-row>
		</transition>
