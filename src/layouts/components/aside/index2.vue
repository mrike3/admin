    ...
    <el-row class="aside2-container">
        <div class="one-menu" v-bind:class="TStore.sideBarIsDark ? 'one-menu-dark' : ''">
            ...
            >
                ...
                <el-text
                    :truncated="true"
                    v-bind:style="TStore.sideBarIsDark ? { color: '#fff' } : ''"
                    size="small"
                    >{{ $t(item.meta.title) }}</el-text
                >
            </div>
        </div>
        <div class="tow-menu">
            <el-container
                v-bind:class="TStore.sideBarIsDark ? 'aside-container-dark' : 'aside-container'"
            >
                ...
                <el-main style="padding: 0">
                    <el-menu
                        class="aside2-menu"
                        v-bind:style="AStore.menuCollapsed ? '' : { width: '222px' }"
                ...
                <el-footer style="padding: 0">
                    <el-row style="height: 100%" justify="center" align="middle">
                        <el-button
                            size="small"
                            circle
                            @click="AStore.menuCollapsed = !AStore.menuCollapsed"
                        >
                            <template #icon>
