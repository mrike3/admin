...
<template>
	...
	<el-row style="width: 100%" justify="space-around" align="middle">
		<el-col :span="7" class="theme-col">
			<div
				class="theme-item"
				v-bind:class="HStore.isDark ? '' : 'theme-item-active'"
				@click="HStore.changeTheme(false)"
			>
	...
	<el-row>
		<el-col :span="24" class="dark-col" style="margin-top: 25px">
			...
			<el-switch
				class="dark-switch"
				v-model="TStore.sideBarIsDark"
				@change="TStore.changeSideBarIsDark()"
			/>
		</el-col>
		<el-col :span="24" class="dark-col" style="margin-top: 20px">
			...
			<el-switch
				class="dark-switch"
				v-model="TStore.topBarIsDark"
				@change="TStore.changeTopBarIsDark()"
			/>
		</el-col>
	</el-row>
	...
	<el-row style="width: 100%; flex-direction: column" justify="center" align="middle">
		<div class="theme-row">
			<el-col
				...
				:key="index"
				@click="TStore.toggleThemeColor(item.color)"
			>
				<div
					class="theme-item"
					v-bind:class="TStore.themeColor == item.color ? 'theme-item-active' : ''"
				>
					<div
						style="border-radius: 5px; width: 20px; height: 20px"
			...
			<el-col :span="7" :xs="5" class="theme-col" @click="a">
				<div class="theme-item">
					...
					<el-input
						type="color"
						v-model="TStore.themeColor"
						style="width: 0; height: 0; opacity: 0"
						@change="TStore.changeThemeColor()"
						id="colorInput"
					/>
				</div>
	...
	<el-row>
		<el-col :span="24" class="dark-col">
			...
			<el-switch
				class="dark-switch"
				v-model="TStore.isInvert"
				@change="TStore.toggleInvert()"
			/>
		</el-col>
		<el-col :span="24" class="dark-col" style="margin-top: 20px">
