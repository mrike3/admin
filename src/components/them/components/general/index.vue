			...
			<div class="general-item">
				<el-select v-model="HStore.language">
					<el-option
						label="简体中文"
						value="zh"
						@click="HStore.toggleLanguage('zh')"
					></el-option>
					<el-option
						label="English"
						value="en"
						@click="HStore.toggleLanguage('en')"
					></el-option>
				</el-select>
			</div>
		</el-col>
	...
	<el-row class="animation-row" justify="space-around" align="middle" v-if="TStore.openAnimate">
		<el-col :span="6" class="animation-col">
			<div
				...
				v-bind:class="TStore.animateType === 'fade1' ? 'animation-active' : ''"
				@click="TStore.toggleAnimate('fade1')"
			>
		...
		<el-col :span="6" class="animation-col">
			<div
				class="animation-item"
				v-bind:class="TStore.animateType === 'fade2' ? 'animation-active' : ''"
				@click="TStore.toggleAnimate('fade2')"
			>
		...
		<el-col :span="6" class="animation-col">
			<div
				class="animation-item"
				v-bind:class="TStore.animateType === 'fade3' ? 'animation-active' : ''"
				@click="TStore.toggleAnimate('fade3')"
			>
		...
		<el-col :span="6" class="animation-col">
			<div
				class="animation-item"
				v-bind:class="TStore.animateType === 'fade4' ? 'animation-active' : ''"
				@click="TStore.toggleAnimate('fade4')"
			>
